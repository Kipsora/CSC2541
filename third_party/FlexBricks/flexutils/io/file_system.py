...
from flexutils.io import hashlib
...
def is_identical_path(a, b, use_real_path: bool = False):
  a = get_absolute_path(a, use_real_path=use_real_path)
  b = get_absolute_path(b, use_real_path=use_real_path)
  return a == b
...
def get_file_checksum(path,
  ...
  with as_file_object(path, mode="rb") as reader:
    ...
    if show_progress_bar:
      ...
      header = CLIColorFormat(bold=True)
